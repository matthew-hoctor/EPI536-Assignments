...
#svyset sdmvpsu [pw=wtmec2yr], strata(sdmvstra)
tabout age_3cat race_eth bmicat food_any if subpop2==1 & male==1 using "T1.csv", c(freq) f(0) replace
#tabout bmiz food_any if subpop2==1 & male==1 using "T1.csv", c(freq col) f(0) append
```
